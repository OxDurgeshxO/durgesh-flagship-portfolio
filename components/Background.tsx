...
export function Background() {
  return (
    ...
    >
      ...
      <div className="absolute -top-40 left-[15%] h-[34rem] w-[34rem] rounded-full bg-primary/14 blur-[130px] animate-float" />
      <div
        className="absolute top-[35%] right-[8%] h-[30rem] w-[30rem] rounded-full bg-secondary/12 blur-[130px] animate-float"
        style={{ animationDelay: "-3s" }}
      />
      <div
        className="absolute bottom-[-10%] left-[30%] h-[32rem] w-[32rem] rounded-full bg-secondary/12 blur-[140px] animate-float"
