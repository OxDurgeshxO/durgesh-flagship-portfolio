...
export async function POST(req: NextRequest) {
  ...
  try {
      ...
      html: `
        <div style="font-family: 'Segoe UI', Arial, sans-serif; max-width: 600px; margin: 0 auto; background: #0f0f1a; color: #e2e8f0; border-radius: 12px; overflow: hidden; border: 1px solid #2d2d4a;">
          ...
          <div style="background: linear-gradient(135deg, #7c3aed, #e11d48); padding: 28px 32px;">
            ...
            <p style="margin: 6px 0 0; font-size: 13px; color: rgba(255,255,255,0.8); font-family: monospace;">
              durgesh-flagship-portfolio · Direct Message Dispatch
            </p>
          </div>
          ...
          <div style="padding: 28px 32px;">
            ...
            <table style="width: 100%; border-collapse: collapse; margin-bottom: 24px;">
              <tr>
                <td style="padding: 10px 14px; background: #1a1a2e; border-radius: 8px 8px 0 0; border-bottom: 1px solid #2d2d4a;">
              ...
              <tr>
                <td style="padding: 10px 14px; background: #1a1a2e; border-bottom: 1px solid #2d2d4a;">
              ...
              <tr>
                <td style="padding: 10px 14px; background: #1a1a2e; border-radius: 0 0 8px 8px;">
            ...
            <div style="margin-top: 24px; text-align: center;">
              <a href="mailto:${cleanEmail}?subject=Re: ${encodeURIComponent(`[Portfolio Contact] ${cleanSubject}`)}"
          ...
          <div style="padding: 16px 32px; background: #0a0a14; border-top: 1px solid #2d2d4a; text-align: center;">
            <p style="margin: 0; font-size: 11px; color: #475569; font-family: monospace;">
              Sent via durgesh-flagship-portfolio · Direct Message Dispatch · Beta
            </p>
          </div>
        </div>
      `,
    ...
    if (resendError) {
      console.error('[Contact API] Resend delivery error:', resendError);
      return NextResponse.json(
