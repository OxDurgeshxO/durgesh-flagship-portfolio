  ...
  loading: () => (
    <section id="hero" className="relative min-h-screen w-full flex items-center justify-center overflow-hidden bg-[var(--bg-primary)] pt-20 pb-16">
      <div className="relative z-20 text-center px-6 max-w-4xl mx-auto">
        <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-primary/40 text-primary text-xs sm:text-sm mb-6">
          <span>AI/ML Engineer &middot; Production AI Systems</span>
        </div>
        <h1 className="text-5xl md:text-7xl font-bold mb-3 leading-tight tracking-tight text-ink">
        ...
        <p className="text-body text-base md:text-lg max-w-2xl mx-auto mb-8 leading-relaxed">
        ...
        <div className="flex flex-wrap gap-3.5 justify-center items-center">
          <a
            href="#projects"
            className="px-7 py-3 rounded-xl bg-gradient-to-r from-[var(--gradient-start)] to-[var(--gradient-end)] text-white font-semibold shadow-lg shadow-black/20 text-sm sm:text-base"
          >
            View Selected Work
          </a>
          <a
            ...
            className="px-6 py-3 rounded-xl bg-accent border border-border-strong text-ink font-semibold text-sm sm:text-base"
          >
            Download Résumé
          </a>
          <a
            href="/resume"
            className="px-5 py-3 rounded-xl glass border border-primary/40 text-primary font-semibold inline-flex items-center gap-2 shadow-lg shadow-black/10 text-sm sm:text-base"
          >
            ATS HTML View
          </a>
          <a
            href="#contact"
            className="px-5 py-3 rounded-xl glass border border-border-strong text-body font-semibold text-sm sm:text-base"
          >
            Contact
          </a>
        </div>
